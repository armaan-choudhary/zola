...
export default function PreviewTiers() {
  return (
    <div style={{
      ...
      <h1 style={{ fontSize: '1.2rem', fontWeight: 300, letterSpacing: '6px', marginBottom: '40px', opacity: 0.6 }}>
      ...
      <div style={{
        display: 'grid',
        gridTemplateColumns: 'repeat(3, 1fr)', // 3 columns for better layout
        gap: '40px',
        transform: 'scale(0.45)', // Scale down further to fit more
        transformOrigin: 'top center',
        width: 'max-content',
        marginBottom: '-600px' // Offset scale space
      }}>
        ...
        {tiers.map((t) => (
          <div key={t.id} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <p style={{ marginTop: '20px', fontSize: '1.2rem', color: '#94a3b8' }}>Phase {t.id}</p>
          </div>
        ))}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div className="card-wrapper">
                <StoryCard type="link-only" creatorName="Armaan" totalStars={120} />
            </div>
            <p style={{ marginTop: '20px', fontSize: '1.2rem', color: '#94a3b8' }}>Invite Card</p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div className="card-wrapper">
                <StoryCard 
                    ...
                    data={{ 
                        sender_name: "Gaurav", 
                        message: "Happy New Year! May this year bring you as much joy as you bring to everyone around you.", 
                        emoji: "❤️", 
                        style: "blue" 
                    }} 
                    creatorName="Armaan" 
            ...
            <p style={{ marginTop: '20px', fontSize: '1.2rem', color: '#94a3b8' }}>Star Message Modal</p>
        </div>
      </div>
    </div>
  );
